# Admission Track Management

## Purpose

Mengelola jalur seleksi per gelombang: kuota, prioritas, validasi terhadap kuota gelombang, dan visibilitas untuk intake applicant.
